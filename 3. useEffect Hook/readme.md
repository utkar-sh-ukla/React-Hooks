...
If you think dependency array is a way to specify when you want to retun the effect, you are going to run into problems. Instead, dependency array should be thought of as a way to let react know about everything that the effect must watch for changes.

### Folder Structure
```
components
    +|__IntervalHookCounter.js
```
### IntervalHookCounter
